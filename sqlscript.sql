...
-- Users
;WITH UserSeed AS (
    SELECT N'Администратор системы' AS FullName, N'admin@hranitelpro.local' AS Email, N'BCRYPT::$2b$10$36lFW8rTkuEiaI4jVwB/fOwaUYbjwnIIEmB3TRDRwBVKdPFj9TG.W' AS PasswordHash, CAST(NULL AS NVARCHAR(50)) AS EmployeeCode, N'Администратор системы' AS RoleName
    UNION ALL SELECT N'Фомичева Авдотья Трофимовна', N'afomicheva@hranitelpro.local', N'BCRYPT::$2b$10$7fZ5dfeNQIlKy0AfSnHIYue9vWUA32VLBDoUzqsinFNfkR/Wqi8r6', N'9367788', N'Оператор пропусков'
    UNION ALL SELECT N'Архипов Тимофей Васильевич', N'tarchipov@hranitelpro.local', N'BCRYPT::$2b$10$UVB9SBwcGLPkKYMsApHKBeswxe3EtAccuYHoMnyMR2HTg3Adm8.nC', N'9362832', N'Сотрудник безопасности'
    UNION ALL SELECT N'Гаврилова Римма Ефимовна', N'rgavrilova@hranitelpro.local', N'BCRYPT::$2b$10$CDwXTbgb6YVI1hCqGsR55emVqS/w07HmP8p.hz0I6xpD6.Y9YLx/2', N'9788737', N'Сотрудник подразделения'
    UNION ALL SELECT N'Носкова Наталия Прохоровна', N'nnoskova@hranitelpro.local', N'BCRYPT::$2b$10$qlmojgrjwhYm.NSe6TWcm.Hs.iadw9wzSDZR.PoPc112nk2SMqF1q', N'9736379', N'Сотрудник подразделения'
)
...
-- Visitor accounts
;WITH VisitorSeed AS (
    SELECT v.FullName, v.Email, v.PasswordHash
    FROM (VALUES
        (N'Степанова Радинка Власовна', N'radinka100@yandex.ru', N'BCRYPT::$2b$10$0QrIyS0ZMeCAw8LRtDoVauW58mnF11piEMwVErNr3xbz1x/hXfOam'),
        (N'Шилов Прохор Герасимович', N'prohor156@list.ru', N'BCRYPT::$2b$10$RVXu0zGVB3AOh2X92twWneRKOWTrbJiGbboAuj.P54SGBa3.Wk2Va'),
        (N'Кононов Юрин Романович', N'yurin155@gmail.com', N'BCRYPT::$2b$10$ZXfxQCW9wPMWelb2zTzpY.KZHptl1Az86ftk0u7obfkA3Vvw2v/NK'),
        (N'Елисеева Альбина Николаевна', N'aljbina33@lenta.ru', N'BCRYPT::$2b$10$H6mnJHBvWRW2gp8zGyeY5.LTfZoMeJdcUQBxZ8LjHFkEmC5HTITCS'),
        (N'Шарова Клавдия Макаровна', N'klavdiya113@live.com', N'BCRYPT::$2b$10$PZs.7XYBePi7yjoonrtUMuGiIvE9nWm3o33/lFbRfvmepCrywM21a'),
        (N'Сидорова Тамара Григорьевна', N'tamara179@live.com', N'BCRYPT::$2b$10$qATwY7IFxiQh3Mr5jtun5uFQxG07d2CqLPJjUMWmxd/MQrY7cVWZK'),
        (N'Петухов Тарас Фадеевич', N'taras24@rambler.ru', N'BCRYPT::$2b$10$USzlUAqxApWVnv5l94LWOeKnWleiMYXl7IMG2ci.tQlDF6cZYMzSW'),
        (N'Родионов Аркадий Власович', N'arkadij123@inbox.ru', N'BCRYPT::$2b$10$0mi0njtMKEzf2Wf8oR2ftuE6tOFZw2meSbYRYTZd/y1oP8VyeNumK'),
        (N'Горшкова Глафира Валентиновна', N'glafira73@outlook.com', N'BCRYPT::$2b$10$o6cXysXFKBRebHPCBgki4u6Vo/gIKq4ChWL3oBib5b0UNPQxKj.RG'),
        (N'Кириллова Гавриила Яковна', N'gavriila68@msn.com', N'BCRYPT::$2b$10$dD.DF9IpIK8yeLupCq6NT.BknSG.WIBLoMuTSWCSpf5iUqbY6rjDC'),
        (N'Овчинников Кузьма Ефимович', N'kuzjma124@yandex.ru', N'BCRYPT::$2b$10$zx8ifdV/qEzM3gQ8Hz2bPuw4jwY3LsvGaTZDOMlWh.R5GnFtEbenu'),
        (N'Беляков Роман Викторович', N'roman89@gmail.com', N'BCRYPT::$2b$10$8XfE0b5.rqnA2R7R.eRkXe.LREJSSlUsO95bLOCMbJzj3OTlWcRMK'),
        (N'Лыткин Алексей Максимович', N'aleksej43@gmail.com', N'BCRYPT::$2b$10$lTRJzy/21tldCaxNUf3y5eslwn.p7VYLmcrpmcS83QHlwMCd9S.jG'),
        (N'Шубина Надежда Викторовна', N'nadezhda137@outlook.com', N'BCRYPT::$2b$10$Ji8dNIY9z4pCKcPWRevCm.K/DjeD8kbFqhHwsnq/AQgScP38EepPi'),
        (N'Зиновьева Бронислава Викторовна', N'bronislava56@yahoo.com', N'BCRYPT::$2b$10$IQ/CvPnHaRnngY55uPOCT.O36c2jCiXa/26RDN3Vq4haBXkCrw90y'),
        (N'Самойлова Таисия Гермоновна', N'taisiya177@lenta.ru', N'BCRYPT::$2b$10$u2C6nb2EI6dzeQ23It.6T.g91JVhf2JjbWHrmGwRjSBgXhZIZiCsC'),
        (N'Ситникова Аделаида Гермоновна', N'adelaida20@hotmail.com', N'BCRYPT::$2b$10$m.hCUa2lUcBib55GJ8m/beyCWhodorX3XzcVKrbRi.nnnus6n/irG'),
        (N'Исаев Лев Юлианович', N'lev131@rambler.ru', N'BCRYPT::$2b$10$CHo9UkM5uFj0fLMnCN/vS.BgbKYAxj7o3r7YulBJ2MQ7gvUmNEPye'),
        (N'Никифоров Даниил Степанович', N'daniil198@bk.ru', N'BCRYPT::$2b$10$HxuCldcuAx5nIIjYgMtlt.lDmrfLy4BTZBv1CPiuQv78cduX0yuEq'),
        (N'Титова Людмила Якововна', N'lyudmila123@hotmail.com', N'BCRYPT::$2b$10$PhzEagtasapDG.IZLLtTr.IDY8VbHM/FYRUV.BnN7msUgf7ew7SrC'),
        (N'Абрамова Таисия Дмитриевна', N'taisiya176@hotmail.com', N'BCRYPT::$2b$10$1nhsLuW5RS2k7L7UVDk/M.MOG0qZFA0G5cCJGO4kt6IXp70DAjLKu'),
        (N'Кузьмина Вера Максимовна', N'vera195@list.ru', N'BCRYPT::$2b$10$CGZhkJ1dIno8x5wRasUUDeV9JKtsftlgryap0czgvAt9KhoYIlWjS'),
        (N'Мартынов Яков Ростиславович', N'yakov196@rambler.ru', N'BCRYPT::$2b$10$lCbUgVyCxpv/oEQUMLxbY.BAJl3TGfgkkoE8JYY2Kv7h1ITYI4AS2'),
        (N'Евсеева Нина Павловна', N'nina145@msn.com', N'BCRYPT::$2b$10$95bSf.IB6A.VMHUNlrgaX.OXzpgZ/a7WuZkUGmQKW5z96YVnc82XK'),
        (N'Голубев Леонтий Вячеславович', N'leontij161@mail.ru', N'BCRYPT::$2b$10$oDRVkEFfhLynLDXyUCo1Heg4/HG12gBB/BpGw6OTNB1u.igDoRZUi'),
        (N'Карпова Серафима Михаиловна', N'serafima169@yahoo.com', N'BCRYPT::$2b$10$JpIENYvJJwZdpNRtselDV.cfZ5whHvdXNQP79a38Ec0r/SADsvVvS'),
        (N'Орехов Сергей Емельянович', N'sergej35@inbox.ru', N'BCRYPT::$2b$10$rzcvPT4QfIrkNDK42/6Ot.xNlqu3nlpnPWzwmGfcGX6JSlZPPTTDG'),
        (N'Исаев Георгий Павлович', N'georgij121@inbox.ru', N'BCRYPT::$2b$10$kuVB4lY5d7x2AN39iqVOkuT7Gx7i3pG3u5NRdlqebQ4Bklwywrnxa'),
        (N'Богданов Елизар Артемович', N'elizar30@yandex.ru', N'BCRYPT::$2b$10$9xvd8fVWi7Bv58aO2UaBeenNN5k/OF78F76loj2raCqL1YNr2fAnC'),
        (N'Тихонова Лана Семеновна', N'lana117@outlook.com', N'BCRYPT::$2b$10$VEdjRjhmCXwNXEluRJLQk.XRxDERKxD6Zl1.lGv4VoXiXJvvtPn7q')
    ) AS v(FullName, Email, PasswordHash)
)
MERGE Users AS target
USING (
    SELECT
